...
{
    const morton masks[6] = {0x1fffff,           0x1f00000000ffff,   0x1f0000ff0000ff,
...
{
    return morton3D_SplitBy3bits(coord.z) | (morton3D_SplitBy3bits(coord.y) << 1) |
           (morton3D_SplitBy3bits(coord.x) << 2);
}
